        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('tools.create') }}" class="btn btn-sm btn-primary"><i class="mdi mdi-plus"></i> Tambah
                        </a>
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">Nama alat</th>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td>
                                    <td class="d-flex"><a href="{{ route('tools.edit', $item->id)}}" class="btn btn-sm btn-info me-2"> <i class="mdi mdi-pencil"></i>
                                            Ubah</a>
